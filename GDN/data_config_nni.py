...
def get_params():
    ...
    # dataset
    parser.add_argument('--dataset_type', type=str, default='yidong-22')
    parser.add_argument('--out_dir', type=str, default='out_env')
...
logger = logging.getLogger('gdn_AutoML')
...
exp_key += f"_{args['embed_dim']}ed"
exp_key += f"_{args['topk']}tk"
...
if dataset_type=='yidong-22':
    ...
    # chosed_index = [1, 6, 11, 17, 26, 35, 50, 59, 68, 77, 83, 90, 95, 99, 102, 103, 75, 88, 94, 107]
